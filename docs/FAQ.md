...
it a question. The Experimental self-hosted push can send fresh database rows after offload,
...
- the CSV/JSON export
- the default-off Experimental self-hosted push on iOS or Android, to an endpoint you own
